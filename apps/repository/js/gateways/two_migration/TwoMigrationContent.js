...
exports.TwoMigrationContent = ReactUtils_1.deepMemo(() => {
    ...
    return (React.createElement(MUIBrowserLinks_1.MUIBrowserLinks, null,
        React.createElement("div", { className: classes.root },
            ...
            React.createElement("h2", null, "What's new in this release?"),
            React.createElement(Feature, { title: "Dark Mode", description: "You can now pick between light and dark mode.", icon: React.createElement(Brightness4_1.default, null) }),
            React.createElement(Feature, { title: "Cloud Only", description: "We're now cloud-only.  Migration from 1.0 is simple and should just take a few minutes.", icon: React.createElement(CloudDone_1.default, null) }),
            React.createElement(Feature, { title: "EPUB Now Supported", description: "EPUB is now a supported document format.", icon: React.createElement(Description_1.default, null) }),
            React.createElement(Feature, { title: "Improved Anki Sync", description: "We've improved our Anki sync support and stability.", icon: React.createElement(Sync_1.default, null) }),
            React.createElement(Feature, { title: "Keyboard Shortcuts", description: "We've dramatically improved our support for keyboad shortcuts.", icon: React.createElement(Keyboard_1.default, null) }))));
});
