...
exports.useFlashcardCallbacks = exports.useFlashcardStore = exports.FlashcardStoreProvider = void 0;
...
function useCallbacksFactory(storeProvider, setStore, mutator) {
    return React.useMemo(() => {
        function setSide(side) {
            ...
            setStore(Object.assign(Object.assign({}, store), { side }));
        }
        return { setSide };
...
}), exports.FlashcardStoreProvider = _a[0], exports.useFlashcardStore = _a[1], exports.useFlashcardCallbacks = _a[2];
