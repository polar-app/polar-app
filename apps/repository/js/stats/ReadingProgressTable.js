...
exports.ReadingProgressTable = void 0;
...
exports.ReadingProgressTable = (props) => {
    ...
    const fromYear = parseInt(ISODateTimeStrings_1.ISODateTimeStrings.toISOYear(days.reduce(Reducers_1.Reducers.FIRST, today)));
    const toYear = parseInt(ISODateTimeStrings_1.ISODateTimeStrings.toISOYear(days.reduce(Reducers_1.Reducers.LAST, today)));
            ...
            React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { style: { height: `${height}px` } },
                    React.createElement("div", { className: "p-1 mr-auto ml-auto", style: { height: '100%', width: '800px' } },
                        React.createElement(calendar_1.ResponsiveCalendar, { data: data, from: from, to: to, emptyColor: theme.palette.background.default, colors: [
                                "rgba(0,0,255,0.1)",
                                "rgba(0,0,255,0.2)",
                                "rgba(0,0,255,0.3)",
                                "rgba(0,0,255,0.4)",
                                ...
                                "bottom": 10,
                                "left": 20
                            }, monthBorderColor: theme.palette.divider, dayBorderColor: theme.palette.divider, theme: nivoTheme }))),
...
//# sourceMappingURL=ReadingProgressTable.js.map