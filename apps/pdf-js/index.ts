...
import {PDFViewer, PDFPageViewOptions, PDFPageView, PDFFindController, EventBus, PDFLinkService, PDFRenderingQueue, DefaultTextLayerFactory} from 'pdfjs-dist/web/pdf_viewer';
...
async function doLoad() {
    ...
    // FIXME: this KIND of works BUT the text layer doesn't work...
    ...
    const pageView = new PDFPageView(opts);
