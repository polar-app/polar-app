...
exports.EPUBThumbnailerStory = void 0;
...
const EPUBThumbnailer_1 = require("polar-epub/src/EPUBThumbnailer");
...
exports.EPUBThumbnailerStory = () => {
    const [thumbnail, setThumbnail] = React.useState();
    const doAsync = React.useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        console.log("Generating thumbnail...");
        const thumbnail = yield EPUBThumbnailer_1.EPUBThumbnailer.generate({
            pathOrURL: url,
            scaleBy: 'width',
            value: 300
        });
...
//# sourceMappingURL=EPUBThumbnailerStory.js.map