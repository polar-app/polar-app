...
exports.PageNextButton = ReactUtils_1.deepMemo(() => {
    const { onPageNext } = DocViewerStore_1.useDocViewerCallbacks();
    const { pageNavigator, page } = DocViewerStore_1.useDocViewerStore(['pageNavigator', 'page']);
    return (React.createElement(IconButton_1.default, { disabled: !pageNavigator || page >= pageNavigator.count, onClick: onPageNext },
