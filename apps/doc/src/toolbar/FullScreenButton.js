...
exports.FullScreenButton = React.memo(() => {
    ...
    return (React.createElement(IconButton_1.default, { onClick: toggleFullScreen },
        React.createElement(Fullscreen_1.default, null)));
});
