...
const bucket = storage.bucket('gs://polar-32b0f.appspot.com');

// const file = new File(bucket, "1LHHqHVdjvSJdcDtA4RK8Pht4SFHHryNJg6B9rTD.pdf");

const file = new File(bucket, "stash/16E7Z6tDWrt3Tveu2qyHEUraLK5Kx38rHiQhq8R2.pdf");
