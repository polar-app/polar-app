...
describe("ShortHeadCalculator", () => {
    ...
    describe("computeAngles", () => {
        ...
        it("basic", () => {
            ...
            // console.log(ShortHeadCalculator.calcAngleBetweenPoints({ x: 1, y: 69.4001677852349 }, { x: 2, y: 64.04152684563759 }))
            // console.log(ShortHeadCalculator.calcAngleBetweenPoints({ x: 2, y: 64.04152684563759 }, { x: 3, y: 39.07298657718121 }))
            // console.log(ShortHeadCalculator.calcAngleBetweenPoints({ x: 3, y: 39.07298657718121 },{ x: 4, y: 37.61535234899329 }))
            // console.log(ShortHeadCalculator.calcAngleBetweenPoints({ x: 4, y: 37.61535234899329 }, { x: 5, y: 34.66338087248322 }))
    ...
    describe("computeAngles", () => {
        ...
        it("test data", () => {
            ...
            const angles = ShortHeadCalculator.computeAngles(normalized);
            assertJSON(angles, [
                {
                    "x": {
                        "value": 0,
    ...
    describe("normalizeY", () => {
        ...
        it("test data", () => {
            ...
            assertJSON(ShortHeadCalculator.normalizeY(TEST_DATA), [
                {
                    "value": 389.2244897959184,
                    "original": 0.019072
                },
