...
export type KeyboardShortcutEventHandler = (event: KeyboardEvent, activeKeys: ReadonlyArray<string>) => void;

export type KeyboardEventHandlerUsingPredicate = (event: KeyboardEvent, activeKeys: ReadonlyArray<string>) => boolean;
