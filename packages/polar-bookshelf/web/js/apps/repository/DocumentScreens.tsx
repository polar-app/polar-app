...
const DefaultSingleDocument: React.FC<IDocumentsScreensProps> = (props) => {
    return (
...
export const DocumentScreens: React.FC<IDocumentsScreensProps> = React.memo(function DocumentScreens(props) {
    if (SIDE_NAV_ENABLED) {
        return <SidenavDocuments {...props} />;
    }

    return <DefaultSingleDocument {...props} />
});
