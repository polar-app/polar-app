 ...
 */
export const GroupInviteFunction = ExpressFunctions.createHookAsync('GroupInviteFunction', async (req, res) => {
    return await UserRequests.executeAsync(req, res, GroupInviteFunctions.exec);
});
