  ...
  return (
    <Layout>
      <ThemeProvider theme={theme}>
        <CssBaseline />
        <SEO
          description="The Polar privacy policy"
          title="Privacy Policy"
          lang="en"
        />

        {/* <Box className="page-title">Privacy Policy</Box>

        <p>Modern and Comprehensive</p> */}
        {/* --- title: POLAR Privacy Policy layout: default --- */}
        <Box
          style={{
            margin: 0,
          }}
        >
          <Box style={{ width: "85vw", maxWidth: "890px", margin: "0 auto" }}>
            <h1 style={{ marginTop: "0", paddingTop: "5%" }}>Privacy Policy</h1>
            <p>
            ...
            <p>
              ...
              geo-location data. What we collect can depend on the inBoxidual
            ...
            <p>
              ...
              United States and Germany, or where we or our partners, affiliates
            ...
            <p>
              <strong>Polar Data Controller</strong>
              <br />
              Kevin Burton
              <br />
              admin@getpolarized.io
            </p>
            <p>
              <strong>Polar Data Protection Officer</strong>
              <br />
              Kevin Burton
              <br />
              admin@getpolarized.io
            </p>
            <p style={{ paddingBottom: "5%", marginBottom: "0px" }}>
