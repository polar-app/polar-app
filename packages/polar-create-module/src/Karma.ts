export namespace Karma {
    export function create() {
        ...
        return `const NodePolyfillPlugin = require("node-polyfill-webpack-plugin");
...
function getFiles() {
    ...
    if (isDirectory(path.resolve(__dirname, 'src'))) {
        filesConfig.push({pattern: './src/**/*TestK.ts', watched: false});
        filesConfig.push({pattern: './src/**/*TestNK.ts', watched: false});
        filesConfig.push({pattern: './src/**/*TestK.tsx', watched: false});
    }
