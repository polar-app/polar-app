    ...
    export async function exec(request: IRegisterForPrivateBetaRequest): Promise<IRegisterForPrivateBetaResponse | IRegisterForPrivateBetaError> {
        ...
        const message = {
            ...
            html: `<p>Hi!</p>
                   ...
                   <p>Want to skip the waitlist and get personal onboarding? Reply to this email and we're happy to walk you through the tool and give you access right now. We'll even give you two weeks of Polar Plus on us.</p>
