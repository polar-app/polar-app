...
export class FirebaseConfig {
    ...
    public static create(project?: string): FirebaseConfig | undefined {
        ...
        if (['polar-32b0f', 'polar-cors', 'polar-webapp-561bd'].includes(project)) {
            ...
            console.warn(`No known project: '${project}'. Try export GCLOUD_PROJECT=polar-32b0f`);
            return undefined;
        }

    }

    private static getProject(): string | undefined {
        return process.env.GCLOUD_PROJECT || process.env.POLAR_TEST_PROJECT || undefined;
    }
