...
const CYRILLIC_CHARS: string = validatedRE(
    "\\u0400-\\u04ff"
);
 ...
 */
const URL_VALID_PATH_ENDING_CHARS: string =
    "[a-z0-9=_#/\\-\\+" + LATIN_ACCENTS_CHARS + CYRILLIC_CHARS + "]|(?:" +
    URL_BALANCED_PARENS + ")";

const URL_VALID_PATH: string = "(?:" +
    "(?:" +
    URL_VALID_GENERAL_PATH_CHARS + "*" +
...
const URL_VALID_URL_QUERY_CHARS: string =
    "[a-z0-9!?\\*'\\(\\);:&=\\+\\$/%#\\[\\]\\-_\\.,~\\|@]";
const URL_VALID_URL_QUERY_ENDING_CHARS: string = "[a-z0-9\\-_&=#/]";

// const VALID_URL_PATTERN_STRING: string =
//     "(" +                                                            //  $1 total match
...
export const VALID_URL_GROUP_URL: number          = 3;
export const VALID_URL_GROUP_PROTOCOL: number     = 4;
export const VALID_URL_GROUP_DOMAIN: number       = 5;
export const VALID_URL_GROUP_PORT: number         = 6;
export const VALID_URL_GROUP_PATH: number         = 7;
export const VALID_URL_GROUP_QUERY_STRING: number = 8;

export const VALID_CASHTAG_GROUP_BEFORE: number = 1;
 ...
 * platform.
 */
// export const VALID_URL = new RegExp(VALID_URL_PATTERN_STRING, 'i');
