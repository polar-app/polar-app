...
exports.RightSidebar = (props) => {
    ...
    const style = Object.assign({ position: 'absolute', right: 0, top: 0, width: `${width}px`, height: '100%', backgroundColor: 'var(--primary-background-color)', color: 'var(--primary-text-color)', zIndex }, props.style || {});
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(framer_motion_1.motion.div, { className: "right-sidebar border-left", initial: {
                opacity: 0.0,
                right: inactiveWidth
            }, animate: {
                opacity: 1.0,
