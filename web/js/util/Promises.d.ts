export declare class Promises {
    static any<T>(p0: Promise<T>, ...morePromises: Array<Promise<T>>): Promise<T>;
    static executeInBackground(promises: ReadonlyArray<Promise<any>>, errorHandler: (err: Error) => void): void;
    static waitFor(timeout: number): Promise<unknown>;
    ...
    static requestAnimationFrame(callback?: () => void): Promise<unknown>;
