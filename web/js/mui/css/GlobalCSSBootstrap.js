...
exports.GlobalCSSBootstrap = void 0;
const withStyles_1 = __importDefault(require("@material-ui/core/styles/withStyles"));
const GlobalCSSBootstrapStyles = withStyles_1.default({
    '@global': {
        ".text-right": {
            textAlign: "right"
        },
...
exports.GlobalCSSBootstrap = GlobalCSSBootstrapStyles(() => null);
//# sourceMappingURL=GlobalCSSBootstrap.js.map