...
class Rects {
    ...
    static createFromLines(xAxis, yAxis) {
        Preconditions_1.Preconditions.assertPresent(xAxis, "xAxis");
        Preconditions_1.Preconditions.assertPresent(yAxis, "yAxis");
...
exports.Rects = Rects;
function interval(min, point, max) {
